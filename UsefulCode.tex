...
\NormalTok{dens <-}\StringTok{ }\KeywordTok{runif}\NormalTok{(}\DecValTok{1000}\NormalTok{)}
...
\NormalTok{colv <-}\StringTok{ "YlOrRd"}
...
\KeywordTok{scatterplot3d}\NormalTok{(}\DataTypeTok{x=}\NormalTok{xx,}\DataTypeTok{y=}\NormalTok{yy,}\DataTypeTok{z=}\NormalTok{dens,}
              ...
              \DataTypeTok{xlab=}\StringTok{"Growth rate of resources"}\NormalTok{,}
              \DataTypeTok{ylab=}\StringTok{"Day"}\NormalTok{,}
              \DataTypeTok{zlab=}\StringTok{"Cercariae density"}\NormalTok{,}
              \DataTypeTok{main=}\NormalTok{ttl,}
              ...
              \DataTypeTok{cex.symbols=}\NormalTok{dens}\OperatorTok{*}\DecValTok{3}\NormalTok{,}
