...
\NormalTok{??graph_from_data_frame}
...
\KeywordTok{ggraph}\NormalTok{(mygraph, }\DataTypeTok{layout =} \StringTok{'circlepack'}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_node_circle}\NormalTok{() }\OperatorTok{+}
...
\StringTok{  }\KeywordTok{geom_edge_diagonal}\NormalTok{() }\OperatorTok{+}
