...
\NormalTok{colv <-}\StringTok{ }\KeywordTok{colorRampPalette}\NormalTok{(}\KeywordTok{c}\NormalTok{(}\StringTok{"white"}\NormalTok{, }\StringTok{"yellow"}\NormalTok{,}\StringTok{"red"}\NormalTok{))}
\NormalTok{colfunc <-}\StringTok{ }\KeywordTok{colv}\NormalTok{(}\KeywordTok{length}\NormalTok{(output}\OperatorTok{$}\NormalTok{X1))[}\KeywordTok{as.numeric}\NormalTok{(}\KeywordTok{cut}\NormalTok{(output}\OperatorTok{$}\NormalTok{X1,}\DataTypeTok{breaks =} \KeywordTok{length}\NormalTok{(output}\OperatorTok{$}\NormalTok{X1)))]}
\KeywordTok{plot}\NormalTok{(}\KeywordTok{rnorm}\NormalTok{(}\DecValTok{10000}\NormalTok{),}\DataTypeTok{col=}\NormalTok{colfunc)}
\end{Highlighting}
\end{Shaded}
