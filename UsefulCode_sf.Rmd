...
### Setting aesthetics for geom_sf()  
...
# change sf to sp 
ddsp <- dd$geometry %>% .[1] %>% st_zm() %>% as("Spatial")

ddhex <- sp::spsample(x = ddsp, type = "hexagonal", cellsize = 30000000) %>% # create spatial sample of points around sp obj
  HexPoints2SpatialPolygons() %>% # convert to hexagons 
