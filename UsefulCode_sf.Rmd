...
# https://rgeomatic.hypotheses.org/1536
library(tanaka)
library(terra)
...
<!-- https://gis.stackexchange.com/questions/307423/st-intersection-failing-for-overlapping-multipolygons-in-sf -->
```{r, join7}
...
<!-- https://jaredlander.com/content/2022/06/GISinR.html#/section-28 -->
```{r, aes2}
library(h3jsr)
df_hex <- sf %>% 
    select(var1) %>% 
...
### Nearest neighbour
<!-- https://github.com/AbdoulMa/30DayMapChallenge/blob/main/Day2/day2_2022.R -->
```{r, nn, eval = F}
library(tidyverse)
library(sf)
library(nngeo)
