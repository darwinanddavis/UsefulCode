...
var color = d3.scaleQuantize()
    .domain([-0.05, 0.05])
    // .range(["#a50026", "#d73027", "#f46d43", "#fdae61", "#fee08b", "#ffffbf", "#d9ef8b", "#a6d96a", "#66bd63", "#1a9850", "#006837"]); // original
    // .range(["#004533","#005C4E","#00726F","#008795","#0095B5","#56A0C8","#8FACD6","#B6BAE0","#D2CAE7","#E6DAEE","#F5EAF5","#FFF7FD"]); // seq
    .range(["#009B9F","#00AAAD","#50B9BC","#89C9CB","#B5D8DA","#DDE8E9","#EDE4EA","#E7CADD","#DFB0D0","#D895C3","#D07AB6","#C75DAA"]); // diverge  
